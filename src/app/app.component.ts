...
@Component({
    ...
    <div class="app-layout">
      <nav class="sidebar">
        <div class="sidebar-header">
          ...
          <div class="brand">
            <span class="brand-name">Flagstone</span>
        ...
        <ul class="nav-links">
          ...
          <li><a routerLink="/monitor" routerLinkActive="active">
            <span class="nav-icon">📊</span> Rate Monitor
          </a></li>
          <li><a routerLink="/onboarding" routerLinkActive="active">
          ...
          <li><a routerLink="/contracts" routerLinkActive="active">
  ...
  styles: [`
    ...
    .logo { width: 36px; height: 36px; background: #2e75b6; border-radius: 8px; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 14px; flex-shrink: 0; }
